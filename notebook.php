...
function notebook($xml){
    ...
    $info_notebook = array(
        ...
        'hd_01des'           => (string) $xml->content->tech_specs->drives->hd_01des,
        'hd_01desftntnbr'    => (string) $xml->content->tech_specs->drives->hd_01desftntnbr,
        'graphicseg_01card_01' =>(string) $xml->content->tech_specs->graphic_subsystem->graphicseg_01card_01,
        'graphiccardftntnbr' => (string) $xml->content->tech_specs->graphic_subsystem->graphiccardftntnbr,
        'ioports' => (string) $xml->content->tech_specs->connectivity_and_communications->ioports,
