<?PHP 
function accesories($xml){

    $info_accesories = array(
        ...
        'legaltagline'      => (string)$xml->content->tech_specs->microsoft->legaltagline,
        ...
        'ltdksp_01_short'   => (string)$xml->content->features->limited_messaging_scenarios->ltdksp_01_short,
        'ltdksp_01_medium'  => (string)$xml->content->features->limited_messaging_scenarios->ltdksp_01_medium,
        'ltdksp_02_short'   => (string)$xml->content->features->limited_messaging_scenarios->ltdksp_02_short,
        'ltdksp_02_medium'  => (string)$xml->content->features->limited_messaging_scenarios->ltdksp_02_medium,
        'ltdksp_03_short'   => (string)$xml->content->features->limited_messaging_scenarios->ltdksp_03_short,
        'ltdksp_03_medium'  => (string)$xml->content->features->limited_messaging_scenarios->ltdksp_03_medium,
        'ltdproddes_short'  => (string)$xml->content->features->limited_messaging_scenarios->ltdproddes_short,
        'ltdproddes_medium' => (string)$xml->content->features->limited_messaging_scenarios->ltdproddes_medium,
