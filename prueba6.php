...
$path_to_xml = __DIR__.'/ACCESORIOS';
...
foreach ($files as $file) {
	...
	if (substr($file, strrpos($file, '.')+1) == 'xml') {
        ...
        $xml = simplexml_load_file(__DIR__."/ACCESORIOS/$file");
        ...
        $info = array(
			...
			'legaltagline' => $xml->content->tech_specs->microsoft->legaltagline,
			...
			'ltdksp_01_short' => $xml->content->features->limited_messaging_scenarios->ltdksp_01_short,
			'ltdksp_01_medium' => $xml->content->features->limited_messaging_scenarios->ltdksp_01_medium,
			'ltdksp_02_short' => $xml->content->features->limited_messaging_scenarios->ltdksp_02_short,
			'ltdksp_02_medium' => $xml->content->features->limited_messaging_scenarios->ltdksp_02_medium,
			'ltdksp_03_short' => $xml->content->features->limited_messaging_scenarios->ltdksp_03_short,
			'ltdksp_03_medium' => $xml->content->features->limited_messaging_scenarios->ltdksp_03_medium,
			'ltdproddes_short' => $xml->content->features->limited_messaging_scenarios->ltdproddes_short,
			'ltdproddes_medium' => $xml->content->features->limited_messaging_scenarios->ltdproddes_medium,
